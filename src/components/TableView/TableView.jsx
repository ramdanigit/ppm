...
//services
import master from "services/produkAsuransiService";
...
function TableView(props) {
  ...
  let filteredData = data.state.filter((value) => {
    return (
      value.kode_produk.toLowerCase().includes(lowercasedFilter) ||
      value.tenor.toLowerCase().includes(lowercasedFilter) ||
      value.rate.toLowerCase().includes(lowercasedFilter) ||
      value.umur.toLowerCase().includes(lowercasedFilter) ||
      value.okupasi.toLowerCase().includes(lowercasedFilter)
    );
  });
  ...
  const deleteUser = async () => {
    try {
      ...
      await master.deleteMaster(openDelete.kode_broker, openDelete.kode_produk);
      setOpenDelete({
        open: false,
        id: "",
        username: "",
  ...
  return (
    <div className={classes.root}>
                        ...
                        <ButtonGroup size="small">
                          ...
                          <Button
                            onClick={() => {
                              setOpenDelete({
                                open: true,
                                kode_broker: produks.kode_broker,
                                kode_produk: produks.kode_produk,
                              });
                            }}
                          >
      ...
      >
        Anda yakin menghapus prodek dengan kode broker {openDelete.kode_broker}{" "}
        dan kode_produk {openDelete.kode_produk} .
      </DialogBasic>
    </div>
  );
}
