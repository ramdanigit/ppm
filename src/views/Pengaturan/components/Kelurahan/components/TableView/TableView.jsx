...
//services
import master from "service/kelurahanService";
...
function TableView(props) {
  ...
  return (
    <div className={classes.root}>
                            ...
                            onClick={() => {
                              setOpenUpdate({
                                ...
                                master: {
                                  ...
                                  kelurahan: produks.kelurahan,
                                  KecamatanId: produks.KecamatanId,
                                  password: "",
                                },
                              });
                            }}
      ...
      >
        Anda yakin menghapus kelurahan dengan nama "{openDelete.kelurahan}"
      </DialogBasic>
    </div>
  );
}
